...
// src/Utilisateur/UtilisateurBundle/DataFixtures/ORM/LoadUtilisateur.php
...
class LoadUtilisateur extends AbstractFixture implements FixtureInterface, ContainerAwareInterface, OrderedFixtureInterface
{
    private $container;
    ...
    /**
     * Méthode retourner en 5e position
     *
     */
