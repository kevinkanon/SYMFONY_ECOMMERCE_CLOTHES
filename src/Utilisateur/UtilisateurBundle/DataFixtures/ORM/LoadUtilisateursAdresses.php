<?php
// src/Utilisateur/UtilisateurBundle/DataFixtures/ORM/LoadUtilisateursAdresses.php
...
class LoadUtilisateursAdresses extends AbstractFixture implements OrderedFixtureInterface
{
