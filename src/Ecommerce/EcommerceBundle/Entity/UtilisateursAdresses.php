...
class UtilisateursAdresses
{
     ...
     * 
     * @ORM\ManyToOne(targetEntity="Utilisateur\UtilisateurBundle\Entity\Utilisateur", inversedBy="utilisateursAdresses")
     ...
     * Set utilisateur.
     *
     * @param \Ecommerce\EcommerceBundle\Entity\Utilisateur|null $utilisateur
     *
     * @return UtilisateursAdresses
     */
