...
// src/Ecommerce/EcommerceBundle/DataFixtures/ORM/LoadProduits.php
...
class LoadProduits extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $produit1->setDescription("Le poivrons rouge est groupe de cultivar de l'espèce capsicum");
        ...
        $produit2->setDescription('Le piment rouge est généralement associé à la saveur du piquant');
        ...
        $produit3->setDescription('La tomate est une èspece de pante heracée');
        ...
        $produit4->setDescription("Le poivrons vert est groupe de cultivar de l'espèce capsicum");
        ...
        $produit5->setDescription('Le raisin est un fruit de la vigne');
        ...
        $produit6->setDescription("L'orange est un agrume, fruit des orangers");
